...
namespace Menus {
    ...
    private:
        ...
        void onLoad() override {
            ...
            Musicbar = GUI::Trackbar(GetStrbyKey("NEWorld.Sound.MusicGain"), 100, settings.BGMGain * 300, -200, 201,
                                     60, 84, 0.5, 0.5, 0.0, 0.0);
            SoundBar = GUI::Trackbar(GetStrbyKey("NEWorld.Sound.SoundGain"), 100, settings.effectGain * 300, -200,
        ...
        void onUpdate() override {
            ...
            settings.BGMGain = float(Musicbar.barpos) / 300.0f;
            settings.effectGain = float(SoundBar.barpos) / 300.0f;
